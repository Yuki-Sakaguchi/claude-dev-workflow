...
**Claude Codeへの指示例**:
```
@templates/preparation-sheet.md を元に、
@requirements/interview-template.md の手順で詳細をヒアリングしてください。
```
...
**Claude Codeへの指示例**:
```
@templates/automation-setup.md に従って、
...
@workflow/development-flow.md に従って進めてください。
```
...
@templates/issue-template.md に従って進めてください。
```
...
**要件定義時**:
```
この準備シートを元に、@requirements/interview-template.md の手順で
...
@workflow/development-flow.md に従って、TDDサイクルで進めてください。
```

**環境構築時**:
```
@templates/automation-setup.md に従って、自動化ツールを設定してください。
設定完了後、動作確認も実行してください。
```
